...
- Индикатор количества оценок для атестации. Если в неделю 1 учебный час нужно 3 оценки, если больше, то 5 оценок. (авто определение работает только при отображении журнала на один аттестационный период и отключеном отображении среднего балла по теме)
- Предупреждение о не выполнении условий атестации
